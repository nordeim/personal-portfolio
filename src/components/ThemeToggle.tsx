...
export function ThemeToggle({ isNightMode, onToggle }: ThemeToggleProps) {
  return (
    <button
      ...
      className="inline-flex items-center gap-2 min-h-[38px] px-3 border rounded-full font-extrabold text-sm transition-colors duration-200
    ...
    >
      <span
        aria-hidden="true"
        className="block w-[18px] h-[18px] border-2 rounded-full bg-current
